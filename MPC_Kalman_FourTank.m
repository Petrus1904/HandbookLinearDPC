...
% Kalman filter. Data acquisition and simulation is subject to sensor noise
...
%Kalman filter stuff
Pk = 1e3*eye(nid);
Rv = SYSid.NoiseVariance;
Qk = Kid*SYSid.NoiseVariance*Kid';
